class Api::V1::FavoriteTripsController < ApplicationController
  ...
  def trip_params
    params.require(:trip).permit(:id, points: [:id, :alias, :name, :image_url, :is_closed, :url, :review_count, :categories, :rating, :coordinates, :transactions, :price, :location, :phone, :display_phone, :distance])
  end
end
